...
<body class="bg-primary">
		...
		<div class="container">
			...
			<div class="card-header"><h3 class="text-center font-weightlight my-4">Login</h3></div>
			<div class="card-body">
		...
		<form action="<?= base_url('login/dologin') ?>" method="POST">
			...
			<div class="d-flex align-items-center justify-contentbetween mt-4 mb-0">
...
<script
src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.1/dist/js/bootstrap.bu
